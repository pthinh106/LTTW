...
namespace LTDT_DoAnCuoiKi_Lalisa
{
    public partial class FormGraph : Form
    {
        ...
        private Class_FS_Graph.Egde Egdes = new Class_FS_Graph.Egde();
        private List<Class_FS_Graph.Egde> ListarrEgde = new List<Class_FS_Graph.Egde> { };
        private bool CheckHuong = false;
        private Class_FS_Graph.NodeGraph Nod = new Class_FS_Graph.NodeGraph();
        private List<Class_FS_Graph.NodeGraph> ListarrNod = new List<Class_FS_Graph.NodeGraph> { };
        ...
        private int i = 0;
        private int dem = 0;
        private List<Class_FS_Graph.Egde> Egl = new List<Class_FS_Graph.Egde> { };
        private List<Class_FS_Graph.NodeGraph> LNodLT = new List<Class_FS_Graph.NodeGraph> { };
        private Class_FS_Graph.Egde Eg = new Class_FS_Graph.Egde();
        private Class_FS_Graph.NodeGraph NodLT = new Class_FS_Graph.NodeGraph();
        ...
        private void btnXoaDinh_Click(object sender, EventArgs e)
        {
            ...
            if (btncreate != null)
            {
                ...
                Class_FS_Graph.NodeGraph NodEgde = new Class_FS_Graph.NodeGraph();
                ...
                else
                {
                    for (int i = 0; i < TPLT.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            ResetLT(pen);
                            pen = null;
                            LNodLT = new List<Class_FS_Graph.NodeGraph> { };
                    }
                }
                    if (Convert.ToInt32(TPLT[0]) == 1)
                    {
        ...
        private void btnLamMoi_Click(object sender, EventArgs e)
        {
            ...
            d1 = -1; d2 = -1;
            Dinh1 = -1; Dinh2 = -1;
            Class_FS_Graph.Egde Egdes = new Class_FS_Graph.Egde();
            ListarrEgde = new List<Class_FS_Graph.Egde> { };
            CheckHuong = false;
            Class_FS_Graph.NodeGraph Nod = new Class_FS_Graph.NodeGraph();
            ListarrNod = new List<Class_FS_Graph.NodeGraph> { };
            PtuxoaNod = -1;
            sodinh = 0;
        ...
        private void VeDoThi1(Class_FS_Graph.Egde NodeG)
        {
            if (cbxLoaiDoThi.Text == "Đồ Thị Vô Hướng")
            {
        ...
        private void VeDoThi2(Class_FS_Graph.Egde NodeG)
        {
            if (cbxLoaiDoThi.Text == "Đồ Thị Vô Hướng")
            {
                Graphics dc = pnlVeDoThi.CreateGraphics();
            ...
            for (int i = 0; i < ListarrEgde.Count; i++)
            {
                ...
                for (int j = 0; j < ListarrNod.Count; j++)
                {
                    for (int l = 0; l < ListarrNod.Count; l++)
                    {
                        ...
                        Class_FS_Graph.NodeGraph Nod2 = new Class_FS_Graph.NodeGraph();
        ...
        private void getDDLT(string a)
        {
            for (int i = 0; i < a.Length ; i++)
            {
                ...
                LNodLT.Add(NodLT);
                NodLT = new Class_FS_Graph.NodeGraph();
            }
        }
